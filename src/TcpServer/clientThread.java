...
public class clientThread extends Thread {
	...
	public void run(String args[])
	{
		...
		final int TRANSACTIONS_BEFORE_COMMIT_ABORT = 10;
		final int TRANSACTIONS_BEFORE_SHUTDOWN = 11;
		...
		while (true) {
			...
			if(numberOfTransactions == TRANSACTIONS_BEFORE_SHUTDOWN )
			{
				command = "shutdown";
			}
			else if(startedTransaction)
			{
				if(numberOfTransactions % TRANSACTIONS_BEFORE_COMMIT_ABORT == 0)
				{
