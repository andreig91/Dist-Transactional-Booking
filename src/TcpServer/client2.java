...
public class client2 {
	...
	public static void main(String args[]) {
		...
		while (true) {
			...
			/*
			 * case 5: // new Customer if (arguments.size() != 2) {
			 * obj.wrongNumber(); break; }
			 * System.out.println("Adding a new Customer using id:" +
			 * arguments.elementAt(1)); try { Id =
			 * obj.getInt(arguments.elementAt(1)); int customer =
			 * rm.newCustomer(Id); System.out.println("new customer id:" +
			 * customer); } catch (Exception e) {
			 * System.out.println("EXCEPTION:");
			 * System.out.println(e.getMessage()); e.printStackTrace(); } break;
			 */
			case 6: // delete Flight
				...
				System.out.println("Flight Number: " + arguments.elementAt(2));
				/*
				 * try { Id = obj.getInt(arguments.elementAt(1)); flightNum =
				 * obj.getInt(arguments.elementAt(2)); if (rm.deleteFlight(Id,
				 * flightNum)) System.out.println("Flight Deleted"); else
				 * System.out.println("Flight could not be deleted"); } catch
			...
			case 8: // delete Room
				...
				break;
			/*
			 * case 9: // delete Customer if (arguments.size() != 3) {
			 * obj.wrongNumber(); break; } System.out
			 * .println("Deleting a customer from the database using id: " +
			 * arguments.elementAt(1)); System.out.println("Customer id: " +
			 * arguments.elementAt(2)); try { Id =
			 * obj.getInt(arguments.elementAt(1)); int customer =
			 * obj.getInt(arguments.elementAt(2)); if (rm.deleteCustomer(Id,
			 * customer)) System.out.println("Customer Deleted"); else
			 * System.out.println("Customer could not be deleted"); } catch
			 * (Exception e) { System.out.println("EXCEPTION:");
			 * System.out.println(e.getMessage()); e.printStackTrace(); } break;
			 */
			...
			case 12: // querying a Room location
				...
				break;
			/*
			 * case 13: // querying Customer Information if (arguments.size() !=
			 * 3) { obj.wrongNumber(); break; }
			 * System.out.println("Querying Customer information using id: " +
			 * arguments.elementAt(1)); System.out.println("Customer id: " +
			 * arguments.elementAt(2)); try { Id =
			 * obj.getInt(arguments.elementAt(1)); int customer =
			 * obj.getInt(arguments.elementAt(2)); String bill =
			 * rm.queryCustomerInfo(Id, customer);
			 * System.out.println("Customer info:" + bill); } catch (Exception
			...
			case 19: // reserve a room
				...
				break;
			/*
			 * case 20: // reserve an Itinerary if (arguments.size() < 7) {
			 * obj.wrongNumber(); break; }
			 * System.out.println("Reserving an Itinerary using id:" +
			 * arguments.elementAt(1)); System.out.println("Customer id:" +
			 * arguments.elementAt(2)); for (int i = 0; i < arguments.size() -
			 * 6; i++) System.out.println("Flight number" +
			 ...
			 * arguments.elementAt(arguments.size() - 1)); try { Id =
			 * obj.getInt(arguments.elementAt(1)); int customer =
			 * obj.getInt(arguments.elementAt(2)); Vector flightNumbers = new
			 * Vector(); for (int i = 0; i < arguments.size() - 6; i++)
			 * flightNumbers.addElement(arguments.elementAt(3 + i)); location =
			 * obj.getString(arguments.elementAt(arguments .size() - 3)); Car =
			 * obj .getBoolean(arguments.elementAt(arguments.size() - 2)); Room
			 * = obj .getBoolean(arguments.elementAt(arguments.size() - 1));
			 * 
			 * if (rm.itinerary(Id, customer, flightNumbers, location, Car,
			 * Room)) System.out.println("Itinerary Reserved"); else
			 * System.out.println("Itinerary could not be reserved."); } catch
			 * (Exception e) { System.out.println("EXCEPTION:");
			 * System.out.println(e.getMessage()); e.printStackTrace(); } break;
			 */
