	...
	public static void main(String args[]) 
	{
		...
		while (true) 
		{
			...
			case 21: // quit the client
				...
				/*
				 * 
				 * case 22: //new Customer given id if(arguments.size()!=3){
				 * obj.wrongNumber(); break; }
				 * System.out.println("Adding a new Customer using id:"
				 * +arguments.elementAt(1) + " and cid "
				 * +arguments.elementAt(2)); try{ Id =
				 * obj.getInt(arguments.elementAt(1)); Cid =
				 * obj.getInt(arguments.elementAt(2)); boolean
				 * customer=rm.newCustomer(Id,Cid);
				 * System.out.println("new customer id:"+Cid); } catch(Exception
